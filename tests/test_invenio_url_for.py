...
# ---
# def test_invenio_apps_urls_builder_w_api_as_this_app():

#     # Case 2 - API app is main app
#     create_app = create_app_factory(
#         # "test", complementary_urls_cls=ComplementaryUrls, config_loader=_config_loader
#     )
#     app = create_app()

#     with app.app_context():
#         # test for endpoint of main app
#         assert "https://example.org/api/foo" == invenio_url_for("endpoint_foo_of_api")
#         # test for endpoint of other app
#         assert "https://example.org/foo" == invenio_url_for("endpoint_foo_of_ui")
# ---

# def test_more_advanced_invenio_url_for_calls_w_invenio_apps_urls_builder():

#     # URL rendering for endpoint of neither
#     with app.app_context():
#         assert_raises(BuildError, invenio_url_for, "endpoint_foo_of_neither")

#     # URL rendering for POST endpoint, with parameter

#     # URL rendering for POST endpoint,without specifying POST as method
